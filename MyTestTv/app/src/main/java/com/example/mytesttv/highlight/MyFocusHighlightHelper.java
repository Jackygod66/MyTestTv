package com.example.mytesttv.highlight;
...
import com.example.mytesttv.R;

public class MyFocusHighlightHelper {
    public static final int ZOOM_FACTOR_XLARGE = 1;
    public static final int ZOOM_FACTOR_LARGE = 2;
    public static final int ZOOM_FACTOR_MEDIUM = 3;
    public static final int ZOOM_FACTOR_SMALL = 4;
    public static final int ZOOM_FACTOR_XSMALL = 5;
    public static final int ZOOM_FACTOR_XXSMALL = 6;
    public static final int ZOOM_FACTOR_XXXSMALL = 7;
